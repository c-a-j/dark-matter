...
export const siteConfig = {
  ...
  global: {
    ...
    description: "Personal website and portfolio of John Doe — software developer, robotics enthusiast, and more.",
    longDescription: "Personal website and portfolio of John Doe — software developer, robotics enthusiast, and more. Explore posts, projects, and experience.",
  ...
  posts: {
    ...
    longDescription: "Browse articles and thoughts on web development, design, and technology by John Doe.",
    cardImage: "/card-image.webp",
    keywords: ["web development", "design", "technology"],
  },
  projects: {
    titleSuffix: "Projects",
    description: "A showcase of software projects and open-source contributions.",
    longDescription: "Explore a showcase of software projects and open-source contributions by John Doe.",
    cardImage: "/card-image.webp",
    keywords: ["web development", "design", "technology"],
  },
  cv: {
    ...
    longDescription: "View the professional experience, education, and skills of John Doe.",
    cardImage: "/card-image.webp",
    keywords: ["web development", "design", "technology"],
    allowSearch: false,
  ...
  search: {
    titleSuffix: "Search",
    description: "Search across all posts, projects, and pages.",
    longDescription: "Search across all posts, projects, and pages on this site.",
    cardImage: "/card-image.webp",
    keywords: ["web development", "design", "technology"],
  },
  notFound: {
